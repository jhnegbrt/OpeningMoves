...
function addAverageExcursion(master, overviewContainer){
  ...
  if (negativeExcursions.length + positiveExcursions.length > 0){
    ...
    let allMorningsTag = document.createTextNode("All Mornings: ")
    let positiveMorningsTag = document.createTextNode("Positive Moves: ")
    let negativeMorningsTag = document.createTextNode("Negative Moves: ")
    let allLabel = document.createElement("p")
    let positiveLabel = document.createElement("p")
    let negativeLabel = document.createElement("p")
    allLabel.appendChild(allMorningsTag)
    positiveLabel.appendChild(positiveMorningsTag)
    negativeLabel.appendChild(negativeMorningsTag)
